  ...
  <div class="content-wrapper">
	...
	<div class="box box-warning">
            <div class="box-header">
              <h3 class="box-title">All New Requests</h3>
            </div>
            <!-- /.box-header -->
             ...
             <table id="example1" class="table table-bordered table-striped  view-student">
				...
				$i=1;
					...
					<tr>
					  ...
					  <td><?php echo "admin"; ?></td>
					  <td>
					  <a href="<?php echo base_url();?>Tenant/viewdetail/" target="_blank" class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="top" title="" data-original-title="View Details" ><i class="fa fa-eye" aria-hidden="true"></i></a>
					  </td>                
					  <td>
