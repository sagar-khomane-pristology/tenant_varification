...
<div class="wrapper">
  ...
  <input type="hidden" id="service_url" value="<?php /* echo $this->session->userdata['user']['profile'][0]['sl_project_url']."index.php/"; */ ?>" name ="service_url">
  
  <header class="main-header">
    <!-- Logo -->
    <a href="javascript:void(0);" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>Ten</b>ant</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Tenant</b> Verification</span>
    </a>
  ...
  <?php $this->load->view('mainSidebar');?>
