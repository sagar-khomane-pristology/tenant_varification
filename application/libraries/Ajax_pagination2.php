...
class Ajax_pagination2{
    ...
    var $next_link       = 'Next Page<i class="fa fa-long-arrow-right"></i>';
    var $prev_link       = '<i class="fa fa-long-arrow-left"></i>Previous Page';
    var $last_link       = 'Last';
    var $uri_segment     = 4;
	...
	function create_links(){
        ...
        if ($this->show_count){
            ...
            $info = '<span style="float: left;padding: 10px 16px 0px 0px;">Showing ' . ( $curr_offset + 1 ) . ' to ' ;
    ...
    function create_links1(){
		$this->base_url = base_url().'Teacher/TSendMessage/ajaxPaginationDataSentBox';
		$this->link_func = 'getData1';
		$this->target = '#sentMessageList';
		$this->uri_segment = 4;
	...
	function create_links2(){
		$this->base_url = base_url().'Teacher/TSendMessage/ajaxPaginationDataRecieveBox';
		$this->link_func = 'getData2';
		$this->target = '#recieveMessageList';
		$this->uri_segment = 4;
	...
	function create_links3(){
		...
		$this->base_url = base_url().'Parents/PViewMessage/ajaxPaginationDataSentBox';
		$this->link_func = 'getData3';
		$this->target = '#sentMessageList';
		$this->uri_segment = 4;
	...
	function create_links4(){
		$this->base_url = base_url().'Parents/PViewMessage/ajaxPaginationDataRecieveBox';
		$this->link_func = 'getData4';
		$this->target = '#recieveMessageList';
		$this->uri_segment = 4;
